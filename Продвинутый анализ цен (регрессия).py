...
# ============================================================
# ПРИМЕР ДЛЯ БЫСТРОГО ЗАПУСКА
# ============================================================

example_flat = pd.DataFrame([{
    "площадь": 110,
    "комнаты": 4,
    "этаж": 18,
    "возраст_дома": 4,
    "расстояние_до_центра": 1.2,
    "расстояние_до_метро": 0.4,
    "школ_рядом": 5,
    "индекс_преступности": 2.1,
    "парковка": 1,
    "лифт": 1,
    "вид_на_море": 1,
    "район": "центр"}])
predicted_log_price = model.predict(example_flat)[0]
predicted_price = np.exp(predicted_log_price)

print("\n")
print("=" * 70)
print("ПРИМЕР ДЛЯ БЫСТРОГО ЗАПУСКА")
print("=" * 70)
print(example_flat)
print(f"\nПрогнозная цена: "f"{predicted_price:,.0f} ₽")